...
public class ClientRequestHandler implements Runnable {
    ...
    private Map<String, ClientRequestHandler> onlineUsers;
    ...
    public boolean validateUser(String nickname, String userPassword) {
        try {
            if (nickname == null || userPassword == null) {
                throw new IllegalArgumentException();
            }
    ...
    public void checkCommandType(String inputLine) {
        try {
            ...
            System.out.println("inputLine is empty! " + i.getMessage());
        }
